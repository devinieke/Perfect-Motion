            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Agent List</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable">
                                            <thead>
                                                ...
                                                <?php
                                                    ...
                                                    $entryCheck = "SELECT * FROM user WHERE Agent='yes'";
                                                    ...
                                                    <td>
                                                        <div class="margin-bottom-5">
                                                            <form action="" method="post">
                                                                <input type="hidden" name="disableAgentID" value="<?php echo $entryUnique?>" class="form-control">
                                                                <button class="btn btn-sm green btn-outline filter-submit margin-bottom" name="disableAgent" type="submit">
