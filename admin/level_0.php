            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Entry Level Users</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="10%"> Upgraded</th>
                                                    <th width="8%"> </th>
                                                </tr>

                                                <?php
                                                    $entryUsers = "SELECT * FROM level_0 as l INNER JOIN user as u ON l.User_ID=u.User_ID WHERE Active=1 AND Status=1";
