                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>List of Requested Bonus Payouts
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                                                    ...
                                                    <td>
                                                        <div class="margin-bottom-5">
                                                            <form action="" method="post">
                                                                <input type="hidden" name="confirmBonusID" value="<?php echo $entryUnique?>" class="form-control">
                                                                <button class="btn btn-sm green btn-outline filter-submit margin-bottom" name="confirmBonus" type="submit">
                                                                    <i class="fa fa-check"></i> Confirm Bonus
                                                                </button>
                                                            </form>
                                                        </div>
