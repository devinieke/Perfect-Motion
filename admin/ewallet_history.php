                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable">
                                            <thead>
                                                ...
                                                <?php
                                                   ...
                                                   $ewallet = "SELECT * FROM e_wallet_history";
                                                ...
                                                <tr role="row" class="filter">
                                                  ...
                                                  while($ewallet_hRow = mysqli_fetch_array($ewallet_hResult))
                                                  {
                                                    ...
                                                    $sph = $ewallet_hRow['Phone_1'];

                                                     ?>
                                                        <?php echo $sfn; ?>  <?php echo $sln; ?> (<?php echo $sph; ?>)
                                                    <?php
                                                    } 
                                                     ?>
                                                    </td>
                                                  ...
                                                  while($ewallet_rRow = mysqli_fetch_array($ewallet_rResult))
                                                  {
                                                    ...
                                                    $cph = $ewallet_rRow['Phone_1'];

                                                     ?>
                                                        <?php echo $cfn; ?>  <?php echo $cln; ?> (<?php echo $cph; ?>)
                                                    <?php
                                                    } 
                                                     ?>
                                                    </td>
