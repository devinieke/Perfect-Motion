...
<html lang="en">
    ...
    <?php
        if(array_key_exists('deep_login', $_POST))
        {
            ...
            if($s_level == 1)
            {
              ...
              $url = 'http://localhost/pm_exclusive/user/dashboard_1.php';
              $str ="<script>window.open($url,'New window');</script>";
              echo $str;
            }
            if($s_level == 2)
            {
              ...
              $_SESSION['username'] = $s_username;
              $url = 'http://localhost/pm_exclusive/user/dashboard_2.php';
              $str ="<script>window.open($url,'New window');</script>";
              echo $str;
            }
            if($s_level == 4)
            {
              ...
              $_SESSION['username'] = $s_username;
              $url = 'http://localhost/pm_exclusive/user/dashboard_4.php';
              $str ="<script>window.open($url,'New window');</script>";
              echo $str;
            }
            if($s_level == 5)
            {
              ...
              $_SESSION['username'] = $s_username;
              $url = 'http://localhost/pm_exclusive/user/dashboard_5.php';
              $str ="<script>window.open($url,'New window');</script>";
              echo $str;
            }
            if($s_level == 6)
            {
              ...
              $_SESSION['username'] = $s_username;
              $url = 'http://localhost/pm_exclusive/user/dashboard_6.php';
              $str ="<script>window.open($url,'New window');</script>";
              echo $str;
            }
            if($s_level == 3)
            {
              ...
              $_SESSION['username'] = $s_username;
              $url = 'http://localhost/pm_exclusive/user/dashboard_3.php';
              $str ="<script>window.open($url,'New window');</script>";
              echo $str;
            }
            else
            {
              ...
              $_SESSION['username'] = $s_username;
              $url = 'http://localhost/pm_exclusive/user/dashboard.php';
              $str ="<script>window.open($url,'New window');</script>";
              echo $str;
            }
        }
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="btn-group">
                                                                    <form action="" method="post" >
                                                                        ...
                                                                        <button id="sample_editable_1_new" class="btn sbold green" data-toggle="modal" name="deep_login" type="submit"> View This User
