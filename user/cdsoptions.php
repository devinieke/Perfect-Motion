...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>CDS Payment Options</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
					...
					<div class="row" style="margin-top:35px;">
						...
						<div class="col-md-8" style="padding:20px; text-align:center;">
						<h4 class="profile-usertitle-name" > Choose your preferred payment option</h4>
						</div>
						<div class="col-md-2"></div>
					</div>
                    <div class="row" style="margin-bottom:5px;"> 
                        ...
                        <div class="portlet-body">
                            <div class="tiles">
                                <div class="tile pm4life selected" style="width:247px!important; height:247px!important;">
                                  <div class="corner"> </div>
                                  <div class="check"> </div>
                                  <div class="tile-body">
                                      <i class="icon-wallet" style="font-size:130px!important;margin-top:70px!important;"></i>
                                      
                                  </div>
                                  <div class="tile-object">
                                    <div class="name"> <a href="ewallet_summary.php?cds_ID=<?php echo $profile_ID; ?>&amount=<?php echo $amount; ?>&type=e-wallet" style="color:#fff;">Pay with my e-Wallet </a></div>
                                        <div class="number">  </div>
                                  </div>
                                </div>
                                <div class="tile bg-red-sunglo selected" style="width:247px!important; height:247px!important;background-color: #0a8fa5!important;">
								<div class="corner"> </div>
                                    <div class="tile-body">
                                        <i class="fa  fa-user" style="font-size:130px!important;margin-top:70px!important;"></i>
                                    </div>
                                    <div class="tile-object">
                                        <div class="name"> <a href="booking.php?cds_ID=<?php echo $profile_ID; ?>&amount=<?php echo $amount; ?>&agentamount=<?php echo $agentamount; ?>&type=Agent&book_type=cds" style="color:#fff;">Pay Agent </a></div>
                                        <div class="number">  </div>
                                    </div>
                                </div>
                                <div class="tile selected bg-yellow-saffron" style="width:247px!important; height:247px!important; background-color: #FF0000!important;" >
                                    <div class="corner"> </div>
									<div class="check"> </div>
                                    <div class="tile-body">
                                       <i class="fa fa-external-link-square" style="font-size:130px!important;margin-top:70px!important;"></i>
                                    </div>
                                    <div class="tile-object">
                                        <div class="name"> <a href="perfectmoney.php?cds_ID=<?php echo $profile_ID; ?>&amount=<?php echo $amount; ?>&type=perfect_money" style="color:#fff;">Pay with E-Currency </div>
