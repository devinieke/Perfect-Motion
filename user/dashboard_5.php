...
<?php
  ...
  while($dashRow = mysqli_fetch_array($dashResult))
  {
    ...
    $stars = $dashRow['Stars'];
            ...
            if($level == 6)
      {
          redirect_to("dashboard_6.php");
      }
      
                    ////// Redirect if Suspened
  $dets = "SELECT * FROM level_5 WHERE User_ID='$profile_ID' AND Active=0";
  $detsResult = mysqli_query($connection, $dets) or die(mysqli_error($connection));
 ...
 <?php
    ...
    $levelChk = "SELECT * FROM merge as m INNER JOIN user as u ON m.Spons_ID=u.User_ID WHERE m.Ben_ID = '$profile_ID' and m.Spons_con=0 and u.Level=6";
            ...
            <div class="page-content-wrapper">
                        ...
                        <div class="portlet-body">
                            ...
                            <?php
                                ...
                                <div class="tile bg-blue selected">
                                  ...
                                  <div class="check"> </div>
                                  <div class="tile-body">
                                    <a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=30000&agentamount=30800" style="color:#fff;"><h4 style="line-height:18px;"><strong>Community Development Service fee</strong></h4><i class="fa  fa-money" style="font-size:48px; padding-top:6px;"></i></a>
                                  </div>
                                  <div class="tile-object">
                                    <div class="name"><a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=30000&agentamount=30800" style="color:#fff;">Pay Now</a></div>
                                  </div>
                                </div>
                                <?php
                                  }
                                ...
                                <div class="tile double pm4life">
                                    <div class="tile-body">
                                        <?php
                                          ...
                                          $user_notify = "SELECT * FROM level_5 WHERE User_ID='$profile_ID'";
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                              ...
                              <h3>My Benefactor Information</h3><h4><?php echo $get_firstname ?>
                                    <?php
                                        if($del_0 < 86400)
                                      {
                                        if($del_0 < 0)
                                        {
                                          echo '<span style="color:red; font-weight:bold;">is due to pay you $240(₦60,000).</span>';   
                                        }
                                        else
                                        {
                                          echo 'will pay you $240(₦60,000) in <span style="color:red; font-weight:bold;">'.$delta_0.'</span> ';
                                        }
                                      }
                                      else
                                      {
                          ...
                          ?>
                          <?php
                          $level3Button = "SELECT * FROM level_5 WHERE User_ID='$profile_ID' AND Merge_2=1";
                          ...
                          {
                          $startButton = "SELECT * FROM level_5 WHERE User_ID='$profile_ID' AND Merge=1";
                ...
                <?php
                  ...
                  <div class="row">
                      ...
                      <h3>My Sponsor Information</h3><h4><?php
                                        if($delta < -86400)
                                      {
                                        echo '<span style="color:red; font-weight:bold;">You are due to pay $600(₦150,000) to </span>';
                                      } 
                                      else
                                      {
                                        echo 'You have <span id="countdown" style="color:red; font-weight:bold;"></span> to pay $600(₦150,000) to';
                                      }
                                     ?>
                                    <?php echo $Mfirstname ?></h4>
                                      <div class="well row">
                                          <div class="col-md-7">
                                          <address>
                                          ...
                                          <!--dismiss upload button-->
                                                ...
                                                ?>
                                                  <div class="col-md-5">
                                                  <a href="payDetail.php?match_ID=<?php echo $M_ID; ?>&ID=<?php echo $lvl_id; ?>&paymentAmount=150000" class="btn btn-sm green">
                ...
                <?php
                    ...
                    <div class="note note-warning">
                                        ...
                                        <p> Your third Match will be pending until you've upgraded to level 6. Please kindly click the Upgade button bellow and pay your sponosor now. <br><br> Thanks</p>
                       ...
                       <form class="" action="" method="post">
                         ...
                         <button type="submit" id="register-submit-btn" class="btn btn-primary mt-ladda-btn ladda-button green" data-style="expand-right" name="upgrade5"><span class="ladda-label"><i class="icon-arrow-right"></i> Upgrade Now</span></button>
                       </form>
                     </p>
                    ...
                    <?php
                        ...
                        }else
                          {
                            ...
                            {
                                $checkmerge_1 = "SELECT * FROM level_5 WHERE User_ID ='$profile_ID' AND Merge_1=1 AND Merge_2=0 AND Merge_3=0";
                            ...
                            <div class="row" style="padding: 16px">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=30000&agentamount=30800" class="btn btn-primary mt-ladda-btn ladda-button green"> Pay Now </a>
                                <?php
                                  }
                                  else
                                  {
                            ...
                            {
                             $confmerge="SELECT * FROM level_5 WHERE User_ID ='$profile_ID' AND (Merge_1=1 AND Merge_2=1) OR (Merge_1=1 AND Merge_2=1 AND Merge_3=1)";
                        ...
                        <?php
                           ...
                           <hr>
                        <?php 
                        $checkactivities ="SELECT * FROM level_4 WHERE User_ID='$profile_ID' AND Completed=1";
                        $checkactivities_result = mysqli_query($connection, $checkactivities) or die(mysqli_error($connection));
                        
                        if(mysqli_num_rows($checkactivities_result) == 0)
                        {
                          ?><p class="alert alert-warning">You have 1 more person to pay you</p><?php  
                        ...
                        ?>
                             ...
                             <div class="row">
                                 ...
                                 <h3>My Sponsor Information</h3><h4><?php echo $get2_firstname ?>
                                    <?php
                                        if($level_3 < 86400)
                                      {
                                        if($level_3 < 0)
                                        ...
                                        {
                                          echo 'will pay you $240(₦60,000) in <span style="color:red; font-weight:bold;">'.$l_delta_0.'</span> ';
                                        }
                                      }
                                      else
                                      {
