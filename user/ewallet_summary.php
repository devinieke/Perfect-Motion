        ...
        <div class="page-container">
          ...
          <?php
            if(isset($_GET['amount']))
            {
              ...
              $ewallet = "SELECT sum(Interest) FROM referral WHERE ref_ID='$profile_ID' AND (payout='' OR payout='0') AND Status=1";
              $ewallet_result = mysqli_query($connection, $ewallet) or die(mysqli_error($connection));

              while($ewallet_row = mysqli_fetch_array($ewallet_result))
              {
                  $ewallet_amount = $ewallet_row['sum(Interest)'];
              }
           ...
           ?>
                                ...
                                <div class="display" style="margin-bottom:2px!important;">
                                    <div class="number">
                                        <h3 class="font-green-sharp">
                                            <span data-counter="counterup" data-value="<?php echo $ewallet_amount?>"><?php echo $ewallet_amount?></span>
                              ...
                              <div class="row">
                                <div class="dashboard-stat2 bordered" style="padding: 15px 15px 15px!important;">
                                  <div class="display" style="margin-bottom:2px!important;">
                                    <div class="number">
                                        <h3 class="font-green-sharp">
                                            <span data-counter="counterup" data-value="<?php echo $eWall?>"><?php echo $eWall ?></span>
                                            <small class="font-green-sharp">₦</small>
                                        </h3>
                                        <small>amount</small>
                                    </div>
            ...
            <div class="row">
                <div class="dashboard-stat2 bordered" style="padding: 15px 15px 35px!important;">
                    <div class="display" style="margin-bottom:2px!important;">
                        <div class="number">
                            <small> You have sufficient funds</small>
                        </div>
                    </div>
                </div>
            </div>
            <form action="" role="form" method="post">
                <div class="row">
                    <input type="hidden" name="required" value="<?php echo $eWall?>" class="form-control">
                    <input type="hidden" name="refAmount" value="<?php echo $ewallet_amount?>" class="form-control">
                    ...
                    <input type="hidden" name="payType" value="<?php echo $$eWallType?>" class="form-control">
                    <button class="btn btn-sm blue btn-outline filter-submit margin-bottom" type="submit" name="eWalletPay">Pay Now</button>
			    </div>
            </form>
            <?php
                }
