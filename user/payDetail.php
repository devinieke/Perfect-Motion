...
<?php
  ...
  if(isset($_GET['match_ID']) && isset($_GET['ID']))
  {
    $sponsor = $_GET['match_ID'];
    $id = $_GET['ID'];

    $sponsQuery = "SELECT * FROM user WHERE User_ID='$sponsor'";
    $sponsResult = mysqli_query($connection, $sponsQuery) or die(mysqli_error($connection));

    while($sponsRow = mysqli_fetch_array($sponsResult))
    {
        $M_ID = $sponsRow['User_ID'];
        $Mfirstname = $sponsRow['First_Name'];
        $Mlastname = $sponsRow['Last_Name'];
        $MbankName = $sponsRow['Bank_Name'];
        $Macc_Name = $sponsRow['Account_Name'];
        $M_img = $sponsRow['Image'];
        $M_gen = $sponsRow['Gender'];
        $Macc_Num = $sponsRow['Acc_No'];
        $M_phone = $sponsRow['Phone_1'];
        $M_phone2 = $sponsRow['Phone_2'];
        $Mtwitter = $sponsRow['Twitter_Url'];
        $Mfbook = $sponsRow['Facebook_Url'];
        $Mlevel = $sponsRow['Level'];
    }
  }
 ?>
                    ...
                    <div class="col-md-7">
                        <div class="portlet box red">
                                                    ...
                                                    <div class="portlet-body form">
                                                        <!-- BEGIN FORM-->
                                                        <form action="" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data">

                                                            <div class="form-body">
                                                                <div class="form-group">
                                                <label class="control-label col-md-3" id="one">Transaction Type</label>
                                                <div class="col-md-8">
                                               ...
                                               <div class="form-group" >
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="amount" class="form-control" placeholder="How much did you pay?" value="<?php echo $amount; ?>" readonly> </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group option3form" >
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                                ...
                                                                <div class="form-group option1form" >
                                                <label class="control-label col-md-3">Which bank branch</label>
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                                        <span class="input-group-addon">
                                                                            <i class="fa fa-circle"></i>
                                                                        </span>
                                                                        <input type="text" name="branch" class="form-control" placeholder="Which bank branch did you pay to?"> </div>
                                                </div>
                                            </div>
                                                                <div class="form-group option1form" >
                                           ...
                                           <div class="form-group">
                                                ...
                                                <input id="exampleInputFile1" type="file" name="payImg">
                                                <input type="hidden" name="userID" value="<?php echo $profile_ID?>" class="form-control">
                                                <input type="hidden" name="sponsorID" value="<?php echo $M_ID?>" class="form-control">
                                                ...
                                                <p class="help-block"> some help text here. </p>
                                                            ...
                                                            <div class="form-actions">
                                                                <button type="submit" class="btn green" name="payUp">Submit</button>
                                ...
                                <h3>My Sponsor Information</h3>
                                                <div class="well row">
                                                    ...
                                                    <address>
                                                        ...
                                                        Phone 2: <strong><?php echo $M_phone2 ?></strong><br>
