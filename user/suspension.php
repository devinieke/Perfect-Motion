            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
					...
					<div class="row" style="margin-top:35px;">
						...
						<h4 class="profile-usertitle-name" > You have been Suspended</h4>
                        <h6 class="profile-usertitle-name" > Your suspension is as a result of your delay in confirming your benefactor(s). Please contact the support for further clarification</h6>
                            <h3 style="color:red; font-weight:bold; font-size:30px;">Your Penalty is $40(N10,000)</h3>
						</div>
						<div class="col-md-2"></div>
					</div>
                    <div class="row" style="margin-bottom:5px;"> 
                        ...
                        <div class="portlet-body">
                            <div class="tiles">
                                <div class="tile bg-red-sunglo selected" style="width:300px!important; height:300px!important;background-color: #0a8fa5!important;">
								<div class="corner"> </div>
                                    <div class="tile-body">
                                        <i class="fa  fa-user" style="font-size:230px!important;margin-top:90px!important;"></i>
                                    </div>
                                    <div class="tile-object">
                                        <div class="name"> <a href="booking.php?amount=10000&agentamount=10250&book_type=suspension" style="color:#fff;">Pay Agent</a></div>
                                        <div class="number">  </div>
                                    </div>
                                </div>
                                <div class="tile selected bg-yellow-saffron" style="width:300px!important; height:300px!important; background-color: #FF0000!important;" >
                                    <div class="corner"> </div>
									<div class="check"> </div>
                                    <div class="tile-body">
                                        <i class="fa fa-external-link-square" style="font-size:230px!important;margin-top:90px!important;"></i>
                                    </div>
                                    <div class="tile-object">
                                        <div class="name"> <a href="perfectmoney.php?book_type=suspension&amount=10000" style="color:#fff;">Pay with E-Currency</a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
