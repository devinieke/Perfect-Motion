...
<?php
  ...
  $dets = "SELECT * FROM level_4 WHERE User_ID='$profile_ID' AND Active=0";
...
<?php
 ...
 <?php
    ...
    $levelChk = "SELECT * FROM merge as m INNER JOIN user as u ON m.Spons_ID=u.User_ID WHERE m.Ben_ID = '$profile_ID' and m.Spons_con=0 and (u.Level=5 OR u.level=6)";
            ...
            <div class="page-content-wrapper">
                        ...
                        <div class="portlet-body">
                            <div class="tiles">
                                ...
                                <div class="tile bg-blue selected">
                                  ...
                                  <div class="check"> </div>
                                  <div class="tile-body">
                                    <a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=18000&agentamount=18600" style="color:#fff;"><h4 style="line-height:18px;"><strong>Community Development Service fee</strong></h4><i class="fa  fa-money" style="font-size:48px; padding-top:6px;"></i></a>
                                  </div>
                                  <div class="tile-object">
                                    <div class="name"><a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=18000&agentamount=18600" style="color:#fff;">Pay Now</a></div>
                                  </div>
                                </div>
                                <?php
                                  }
                                ...
                                <div class="tile double pm4life">
                                    <div class="tile-body">
                                        <?php
                                          ...
                                          $user_notify = "SELECT * FROM level_4 WHERE User_ID='$profile_ID'";
                ...
                <?php
                  ...
                  <div class="row">
                      ...
                      <h3>My Sponsor Information</h3><h4><?php
                                        if($delta < -86400)
                                      {
                                        echo '<span style="color:red; font-weight:bold;">You are due to pay $400(₦100,000) to </span>';
                                      } 
                                      else
                                      {
                                        echo 'You have <span id="countdown" style="color:red; font-weight:bold;"></span> to pay $400(₦100,000) to';
                                      }
                                     ?>
                                    <?php echo $Mfirstname ?></h4>
                                      <div class="well row">
                                          ...
                                          <!--dismiss upload button-->
                                                ...
                                                ?>
                                                  <div class="col-md-5">
                                                  <a href="payDetail.php?match_ID=<?php echo $M_ID; ?>&ID=<?php echo $lvl_id; ?>&paymentAmount=100000" class="btn btn-sm green">
                ...
                <?php
                    ...
                    <div class="note note-warning">
                                        ...
                                        <p> Your third Match will be pending until you've upgraded to level 5. Please kindly click the Upgade button bellow and pay your sponosor now. <br><br> Thanks</p>
                    ...
                    <?php
                        ...
                        }else
                          {
                            ...
                            {
                                $checkmerge_1 = "SELECT * FROM level_4 WHERE User_ID ='$profile_ID' AND Merge_1=1 AND Merge_2=0 AND Merge_3=0";
                            ...
                            <div class="row" style="padding: 16px">
                                <div class="note note-warning">
                                  ...
                                  {
                                ?>
                                <a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=18000&agentamount=18600" class="btn btn-primary mt-ladda-btn ladda-button green"> Pay Now </a>
                                <?php
                                  }
                                  else
                                  {
                            ...
                            {
                             $confmerge="SELECT * FROM level_4 WHERE User_ID ='$profile_ID' AND (Merge_1=1 AND Merge_2=1) OR (Merge_1=1 AND Merge_2=1 AND Merge_3=1)";
                        ...
                        <?php
                           ...
                           <hr>
                        <?php 
                        $checkactivities ="SELECT * FROM level_3 WHERE User_ID='$profile_ID' AND Completed=1";
                                 ...
                                 <h3>My Sponsor Information</h3><h4><?php echo $get2_firstname ?>
                                    <?php
                                        if($level_3 < 86400)
                                      {
                                        if($level_3 < 0)
                                        {
                                          echo '<span style="color:red; font-weight:bold;">is due to pay you $120(₦40,000).</span>';   
                                        }
                                        else
                                        {
                                          echo 'will pay you $120(₦40,000) in <span style="color:red; font-weight:bold;">'.$l_delta_0.'</span> ';
                                        }
                                      }
                                      else
                                      {
