...
<?php
  ...
  while($dashRow = mysqli_fetch_array($dashResult))
  {
    ...
    $stars = $dashRow['Stars'];
           ...
           if($level == 3)
      {
          redirect_to("dashboard_3.php");
      } 
      
             ////// Redirect if Suspened
      $dets = "SELECT * FROM level_2 WHERE User_ID='$profile_ID' AND Active=0";
      $detsResult = mysqli_query($connection, $dets) or die(mysqli_error($connection));
 ...
 <?php
    ...
    $levelChk = "SELECT * FROM merge as m INNER JOIN user as u ON m.Spons_ID=u.User_ID WHERE m.Ben_ID ='$profile_ID' and m.Spons_con=0 and (u.Level=3 OR u.level=4)";
                        ...
                        <div class="portlet-body">
                            <div class="tiles">
                                ...
                                <div class="tile bg-blue selected">
                                  ...
                                  <div class="check"> </div>
                                  <div class="tile-body">
                                    <a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=6000&agentamount=6300" style="color:#fff;"><h4 style="line-height:18px;"><strong>Community Development Service fee</strong></h4><i class="fa  fa-money" style="font-size:48px; padding-top:6px;"></i></a>
                                  </div>
                                  <div class="tile-object">
                                    <div class="name"><a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=6000&agentamount=6300" style="color:#fff;">Pay Now</a></div>
                                  </div>
                                </div>
                                <?php
                                  }
                                ...
                                <div class="tile double selected pm4life">
                                    ...
                                    <div class="tile-body">
                                        ...
                                        <p> contact us via email, if your Benefactori s delaying your payment </p>
                                    </div>
                                    <div class="tile-object">
                                        <div class="name">
                                ...
                                <div class="tile double pm4life">
                                    <div class="tile-body">
                                        <?php
                                          ...
                                          $user_notify = "SELECT * FROM level_2 WHERE User_ID='$profile_ID'";
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                              ...
                              <h3>My Benefactor Information</h3><h4><?php echo $get_firstname ?>
                                    <?php
                                        if($del_0 < 86400)
                                      {
                                        if($del_0 < 0)
                                        {
                                          echo '<span style="color:red; font-weight:bold;">is due to pay you $80(₦20,000).</span>';
                                        }
                                        else
                                        {
                                          echo 'will pay you $80(₦20,000) in <span style="color:red; font-weight:bold;">'.$delta_0.'</span> ';
                                        }
                                      }
                                      else
                                      {
                                    ...
                                    <div class="col-md-5">
                                       <?php
                                        ...
                                        <form class="" action="" method="post">
                                          ...
                                          <button class="btn red btn-large" name="conPay2" type="submit"title="">Confirm Payment</button>
                                        </form>
                                        <?php
                                          }
                                         ?>
                          ...
                          <?php
                            ...
                            {
                              $upgradeButton = "SELECT * FROM level_2 WHERE User_ID='$profile_ID' AND completed=1";
                              ...
                              if($total == 1)
                              {
                                    $startButton = "SELECT * FROM level_2 WHERE User_ID='$profile_ID' AND Merge=1";
                          ...
                          <?php
                            ...
                            <div class="row">
                                ...
                                <h3>My Sponsor Information</h3><h4><?php
                                        if($delta < -86400)
                                      {
                                        echo '<span style="color:red; font-weight:bold;">You are due to pay $120(₦40,000) to </span>';
                                      }
                                      else
                                      {
                                        echo 'You have <span id="countdown" style="color:red; font-weight:bold;"></span> to pay $120(₦40,000) to';
                                      }
                                     ?>
                                    <?php echo $Mfirstname ?></h4>
                                                ...
                                                ?>
                                                  <div class="col-md-5">
                                                  <a href="payDetail.php?match_ID=<?php echo $M_ID; ?>&ID=<?php echo $lvl_id; ?>&paymentAmount=40000" class="btn btn-sm green">
                          ...
                          <?php
                              ...
                              <div class="note note-success">
                                        ...
                                        <p> It's time to Upgrade to Level 3. We advice you to complete your down-line transaction before clicking the upgrade button. <br><br> Thanks </p>
                               ...
                               <p>
                                 <form class="" action="" method="post">
                                   ...
                                   <button type="submit" id="register-submit-btn" class="btn btn-primary mt-ladda-btn ladda-button green" data-style="expand-right" name="upgrade2"><span class="ladda-label"><i class="icon-arrow-right"></i> Upgrade Now</span></button>
                                 </form>
                               </p>
                            ...
                            {
                                $checkmerge_1 = "SELECT * FROM level_2 WHERE User_ID ='$profile_ID' AND Merge_1=1 AND Merge_2=0 AND Merge_3=0";
                            ...
                            <div class="row" style="padding: 16px">
                                ...
                                <?php
                                  ...
                                  {
                                ?>
                                  <a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=6000&agentamount=6300" class="btn btn-primary mt-ladda-btn ladda-button green"> Pay Now </a>
                                <?php
                                  }
                                  else
                                  {
                            ...
                            {
                             $confmerge="SELECT * FROM level_2 WHERE User_ID ='$profile_ID' AND (Merge_1=1 AND Merge_2=1) OR (Merge_1=1 AND Merge_2=1 AND Merge_3=1)";
                        ...
                        <?php
                                ...
                                ?>
                                <!-- <a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=6000&agentamount=6250"><img src="../assets/images/paycds.jpg" class="img-responsive pic-bordered" alt=""/></a> -->
                                <?php
                          ...
                          <?php
                             ...
                             {
                           ?>
                          <?php include '../includes/pending_activities.php'; ?>
                          <?php
                             }
                             if($aux_level == 5)
                             {
                           ?>
                           <?php include '../includes/pending_5_activities.php'; ?>
                           <?php
                             }
                            ?>
                          <!-- pending level 4 activities -->
