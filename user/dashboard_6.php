...
<?php
  ...
  while($dashRow = mysqli_fetch_array($dashResult))
  {
    ...
    $stars = $dashRow['Stars'];
            ...
            if($level == 7)
      {
          redirect_to("dashboard_7.php");
      }
      
                    ////// Redirect if Suspened
  $dets = "SELECT * FROM level_6 WHERE User_ID='$profile_ID' AND Active=0";
  $detsResult = mysqli_query($connection, $dets) or die(mysqli_error($connection));
 ...
 ?>
  ...
  <?php
    ...
    $levelChk = "SELECT * FROM merge as m INNER JOIN user as u ON m.Spons_ID=u.User_ID WHERE m.Ben_ID = '$profile_ID' and u.Level=6";
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                          <?php
                            $mergeChk = "SELECT * FROM merge as e INNER JOIN user as u ON e.Ben_ID=u.User_ID WHERE u.Level=5 AND e.Spons_Con=0 AND e.Spons_ID='$profile_ID'";
                              ...
                              <h3>My Benefactor Information</h3><h4><?php echo $get_firstname ?>
                                    <?php
                                        if($del_0 < 86400)
                                      {
                                        if($del_0 < 0)
                                        {
                                          echo '<span style="color:red; font-weight:bold;">is due to pay you $600(₦150,000).</span>';   
                                        }
                                        else
                                        {
                                          echo 'will pay you $600(₦150,000) in <span style="color:red; font-weight:bold;">'.$delta_0.'</span> ';
                                        }
                                      }
                                      else
                                      {
                                  ...
                                  $selectMerge = "SELECT * FROM merge WHERE id='$merge' AND Ben_Con=1";
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <form class="" action="" method="post">
                                          ...
                                          <button class="btn red btn-large" name="conPay6" type="submit"title="">Confirm Payment</button>
                                        </form>
                                        <?php } ?>
                                        </div>
                                    </div>
                          ...
                          <?php
                            ...
                            {
                              $upgradeButton = "SELECT * FROM level_6 WHERE User_ID='$profile_ID' AND completed=1";
                              ...
                              <div class="note note-warning">
                                        ...
                                        <p> Congratulations, you can now upgrade to Elite Group <br><br> Thanks </p>
                               ...
                               <p>
                                 <form class="" action="" method="post">
                                   <input type="hidden" name="startID" value="<?php echo $profile_ID?>" class="form-control">
                                     <button type="submit" id="register-submit-btn" class="btn btn-primary mt-ladda-btn ladda-button green" data-style="expand-right" name="elite"><span class="ladda-label"><i class="icon-arrow-right"></i> Upgrade to Elite</span></button>
                                 </form>
                               </p>
                              <?php
                               }
                            ...
                            <div class="row" style="padding: 16px">
                                <div class="note note-warning">
                                  ...
                                  {
                                ?>
                                <a href="cdsoptions.php?cds_ID=<?php echo $profile_ID; ?>&amount=45000&agentamount=46000" class="btn btn-primary mt-ladda-btn ladda-button green"> Pay Now </a>
                                <?php
                                  }
                                  else
                                  {
                            ...
                            {
                             $confmerge="SELECT * FROM level_6 WHERE User_ID ='$profile_ID' AND (Merge_1=1 AND Merge_2=1) OR (Merge_1=1 AND Merge_2=1 AND Merge_3=1)";
                        ...
                        <?php
                          ...
                          ?>
                           ...
                           <hr>
                                                   <?php 
                        $checkactivities ="SELECT * FROM level_5 WHERE User_ID='$profile_ID' AND Completed=1";
                        ...
                        ?>
                             <?php
                               $level2Chk = "SELECT * FROM merge as e INNER JOIN user as u ON e.Ben_ID=u.User_ID WHERE u.Level=4 AND e.Spons_Con=0 AND e.Spons_ID='$profile_ID'";
                                 ...
                                 <h3>My Sponsor Information</h3><h4> <?php echo $get2_firstname ?>
                                    <?php
                                        if($level_3 < 86400)
                                      {
                                        if($level_3 < 0)
                                        {
                                          echo '<span style="color:red; font-weight:bold;">is due to pay you $400(₦100,000).</span>';   
                                        }
                                        else
                                        {
                                          echo 'will pay you $400(₦100,000) in <span style="color:red; font-weight:bold;">'.$l_delta_0.'</span> ';
                                        }
                                      }
                                      else
                                      {
