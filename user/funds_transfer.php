...
<html lang="en">
    ...
    <head>
        ...
        .dashboard-stat2, .dashboard-stat2 .display {
            ...
            .dashboard-stat2 .display .number .divider {
            font-size: 20px;
            color: #FFFFFF;
            font-weight: 600;
                ...
                <div class="page-content">
                    ...
                    <div class="col-md-6">
                        <div class="mt-element-list">
                                ...
                                <div class="display" style="margin-bottom:2px!important;">
                                    <div class="number">
                                        <small>Beneficiary Full Name</small>
                                    </div>
                                </div>
                            </div>
                                            </div>
                        ...
                        <div class="mt-element-list">
                                ...
                                <div class="display" style="margin-bottom:2px!important;">
                                    <div class="number">
									<input type="text" name="ben_name" class="form-control" placeholder="Musa Adamu" required>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-pie-chart"></i>
                                    </div>
					...
					<button class="btn btn-sm blue btn-outline filter-submit margin-bottom" name="transfer" type="submit" onclick='Javascript:checkEmail();'>
                                                              Pay Now
                                                              </button>
					</div>
                        </form>
